      ...
      <div className="container mx-auto px-6 z-10 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative">
          <div className="aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl transform rotate-2 hover:rotate-0 transition-all duration-700 bg-gray-100">
             {/* Use the banner provided */}
            <img src="BlockValleyBanner.jpg" alt="Block Valley Banner" className="w-full h-full object-cover" />
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {philosophyData.map((item, index) => (
            ...
            >
              ...
              <div className="absolute bottom-8 left-8 right-8 transition-all duration-500 transform translate-y-0 group-hover:-translate-y-16">
                <h3 className="text-2xl font-bold text-gray-900">{item.title}</h3>
              </div>

              <div className="absolute bottom-0 left-0 w-full p-8 translate-y-full transition-transform duration-300 group-hover:translate-y-0 bg-white/95 backdrop-blur-sm">
               ...
               <div className="bg-black rounded-2xl overflow-hidden aspect-video relative flex items-center justify-center group cursor-pointer">
                  ...
                  <div className="flex items-end space-x-1 h-20">
                     {[...Array(10)].map((_, i) => (
                       <div 
                        key={i} 
                        className="w-3 bg-pink-500 rounded-t-sm animate-sound-wave"
                        style={{ 
      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2">
            <img src="BlockValleyLogoCut.png" alt="Logo" className="h-12 w-auto mb-6" />
